...
class _$_AppState implements _AppState {
  ...
  @override
  String toString() {
    return 'AppState(currentLanguageCode: $currentLanguageCode, themeData: $themeData, fontScale: $fontScale, layerIndex: $layerIndex)';
  }
  ...
  int get hashCode => Object.hash(
      runtimeType, currentLanguageCode, themeData, fontScale, layerIndex);
...
abstract class _AppState implements AppState {
  const factory _AppState(
      ...
      final ThemeData? themeData,
      final double? fontScale,
      final int layerIndex}) = _$_AppState;
