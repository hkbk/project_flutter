...
class SnakeViewState extends State<SnakeView> {
  ...
  void addListener() {
    widget.notifier.addListener(() {
      if( widget.notifier.currentIndex !=4) {
        ...
        widget.notifier.selectIndexWithoutNotify(widget.notifier.lastIndex);
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    ...
    final snakeViewWidth = oneItemWidth! * snakeSize;
