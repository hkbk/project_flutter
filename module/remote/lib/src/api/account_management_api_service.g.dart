...
part of 'account_management_api_service.dart';
...
class _AccountManagementApiService implements AccountManagementApiService {
  ...
  Future<LinkedAccountResponse> getLinkedAccount(
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<LinkedAccountResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = LinkedAccountResponse.fromJson(_result.data!);
    return value;
  }
  ...
  Future<UpdateEmailResponse> updateGenerateOTPEmailAccountDetails(
    ...
    _data.addAll(request?.toJson() ?? <String, dynamic>{});
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<UpdateEmailResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
  ...
  Future<RemoveChildAccountResponse> removeChildAccount(
    ...
    _data.addAll(request?.toJson() ?? <String, dynamic>{});
    final _result = await _dio.fetch<Map<String, dynamic>>(
        _setStreamType<RemoveChildAccountResponse>(Options(
      method: 'POST',
      headers: _headers,
      extra: _extra,
    )
            ...
            .copyWith(baseUrl: baseUrl ?? _dio.options.baseUrl)));
    final value = RemoveChildAccountResponse.fromJson(_result.data!);
    return value;
  }
