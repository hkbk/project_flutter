...
part of 'get_historical_vas_request.dart';
...
GetHistoricalVasRequest _$GetHistoricalVasRequestFromJson(
    Map<String, dynamic> json) {
  return _GetHistoricalVasRequest.fromJson(json);
}

/// @nodoc
mixin _$GetHistoricalVasRequest {
  ...
  @JsonKey(ignore: true)
  $GetHistoricalVasRequestCopyWith<GetHistoricalVasRequest> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $GetHistoricalVasRequestCopyWith<$Res> {
  factory $GetHistoricalVasRequestCopyWith(GetHistoricalVasRequest value,
          $Res Function(GetHistoricalVasRequest) then) =
      _$GetHistoricalVasRequestCopyWithImpl<$Res, GetHistoricalVasRequest>;
  @useResult
  $Res call(
...
/// @nodoc
class _$GetHistoricalVasRequestCopyWithImpl<$Res,
        $Val extends GetHistoricalVasRequest>
    implements $GetHistoricalVasRequestCopyWith<$Res> {
  _$GetHistoricalVasRequestCopyWithImpl(this._value, this._then);
...
class __$$_GetHistoricalVasRequestCopyWithImpl<$Res>
    extends _$GetHistoricalVasRequestCopyWithImpl<$Res,
...
class _$_GetHistoricalVasRequest implements _GetHistoricalVasRequest {
  ...
  @override
  String toString() {
    return 'GetHistoricalVasRequest(mobileNo: $mobileNo, accountNo: $accountNo)';
  }
...
abstract class _GetHistoricalVasRequest implements GetHistoricalVasRequest {
